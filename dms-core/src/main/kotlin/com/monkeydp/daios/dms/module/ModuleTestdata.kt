...
object ModuleTestdata {
    private val dsVersion get() = DmShareKodeinHelper.findDsVersion(Datasource.valueOf(DATASOURCE), DS_VERSION_ID)
    val cps get() = DmShareKodeinHelper.finalAllImpls<Set<ConnProfile>>(SdkTestCp::class).flatten()
